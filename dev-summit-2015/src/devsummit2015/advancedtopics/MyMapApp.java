...
public final class MyMapApp {
  ...
  private enum MapClickOperation { ADD_STOPS, ADD_BARRIERS, IMPACT_ANALYSIS, DISABLE_LIVE_ROUTE }
  ...
  private ActionListener onBtnDownloadClick = new ActionListener() {
    @Override
    public void actionPerformed(ActionEvent e) {
      GeodatabaseSyncTask geodatabaseSyncTask = new GeodatabaseSyncTask(ONLINE_SERVICE_URL, null);
      ...
      // response callback
      CallbackListener<String> responseCallback = new CallbackListener<String>() {
        @Override
        ...
        public void onCallback(String path) {
          showMessage("File downloaded to: " + path);
        }
      };

      // Generate the geodatabase from the service and download
      geodatabaseSyncTask.generateGeodatabase(params, GEODATABASE_FILE_PATH, true, statusCallback, responseCallback);
  ...
  private ActionListener onBtnGoOfflineClick = new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      try {
        ...
        FeatureTable offlineData = offlineSource.getGeodatabaseFeatureTableByLayerId(0);
    ...
    onMapClickEdit = new MapOverlay() {
      ...
      public void onMouseClicked(MouseEvent event) {
        ...
        try {
          ...
          final PopupDialog popup = featureLayer.getMap().createPopup(new JComponent[]{content}, hitFeature);
  ...
  private ActionListener onBtnLiveRouteClick = new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
      liveRoute = true;
      onMapClickOperation = MapClickOperation.DISABLE_LIVE_ROUTE;
    }
  };
  ...
  private ActionListener onBtnSyncClick = new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        ...
        GeodatabaseSyncTask syncTask = new GeodatabaseSyncTask(ONLINE_SERVICE_URL, null);
        ...
        CallbackListener<Map<Integer, GeodatabaseFeatureTableEditErrors>> responseCallback = 
          ...
          @Override
          public void onCallback(Map<Integer, GeodatabaseFeatureTableEditErrors> errors) {
            showMessage("Data uploaded.");
          }
        };

        // sync
        syncTask.syncGeodatabase(params, geodatabase, statusCallback, responseCallback);
      } catch (Exception ex) {
        showError(ex);
      }
    }
