...
public class GeometryOfflineApp {
  ...
  final static SimpleMarkerSymbol SYM_POINT =
      new SimpleMarkerSymbol(new Color(255, 0, 0, 200), 8, Style.CIRCLE);
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        try {
          ...
          GeometryOfflineApp geometryApp = new GeometryOfflineApp();
